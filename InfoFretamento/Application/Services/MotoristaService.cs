...
{
    public class MotoristaService(IBaseRepository<Motorista> repository, IPessoaRepository<Motorista> pessoaRepository, IMemoryCache cache) : BasePessoaService<Motorista, AdicionarMotoristaRequest, AtualizarMotoristaRequest>(repository, pessoaRepository, cache)
    {
